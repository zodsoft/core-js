...
_.extend(Controller, new function() {
  ...
  this.routingFunctions = new function() {
    ...
    this.publicRouteGetPost 
    = this.publicRoutePostGet
    = this.public_getpost
    = this.public_postget
    = function(route, arg2, arg3, arg4) {
    ...
    this.privateRouteGetPost 
    = this.privateRoutePostGet
...
_.extend(Controller.prototype, new function() {
        ...
        if (route.method.test(req.method)) {
          ...
          if (req.method === 'POST') {
            ...
            req.getPostData(function(fields, files) {
              ...
              cb = function() {
                if (route.authRequired) {
                  if (req.__session.user != null) {
                    ...
                    this.app.controller.cleanupFilesUploaded(files, true);
                    this.app.login(res);
                  }
                } else {
                  route.callback.call(self, req, res);
              ...
              if (typeof app.session === 'object' && typeof app.session.loadSession === 'function') {
