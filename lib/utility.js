...
_.extend(Utility.prototype, new function() {
  ...
  */
   ...
   */
   ...
   this.onlySetEnumerable = function(context, properties) {
   ...
   */
   ...
   this.runInitFunction = function(context, constructContext) {
     if (typeof context.initialize === 'function') {
       // Run initialize if method exists
       context.initialize();
     }
     if (typeof constructContext === 'object' && typeof context.app === 'undefined') {
       // Run constructor if context.app is not available
       context.__construct.call(context, constructContext);
     }
   }
