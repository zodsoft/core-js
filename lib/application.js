...
_.extend(Application.prototype, new function() {
  ...
  this.__construct = function(domain, path) {
    ...
    // Skip if creating the prototype
    ...
    framework.util.requireAllTo(this.path + "/lib", this.lib, requireCb = function(func, prototype) {
      func = addClassInheritance.call(self, func);
      if (prototype) _.extend(func.prototype, prototype);
      var instance = new func(self);
      framework.util.runInitFunction(instance, self); // automatically run constructor if it is not called
    ...
    framework.util.requireAllTo(this.path + "/helpers", this.helpers, function(func) {
      return requireCb.call(self, func, self.lib.helper || framework.helperProto);
    });
    
    // Get models/
    framework.util.requireAllTo(this.path + "/models", this.models, function(func) {
      return requireCb.call(self, func, self.lib.model || framework.modelProto);
    });
    ...
    framework.util.requireAllTo(this.path + "/engines", this.engines, function(func) {
      return requireCb.call(self, func, self.lib.engine || framework.engineProto);
    });
    ...
    /* TODO: ability for apps to extend template engines */
    ...
    framework.util.onlySetEnumerable(this, 
      ['className', 'debugMode', 'baseUrl', 'path', 'lib', 'helpers', 'models', 'engines', 'controllers']);
...
(function() {\n\n\
  ...
  /**
    Enables a function to use `this.extends` to extend a framework class
  ...
  function addClassInheritance(func) {
    ...
    /* TODO: accept func as object, allowing arbitrary prototypes */
...
" + func.name + ".prototype.extends = function(name, args) {\n\
  var proto = app.getClass(name);\n\
  if (typeof proto === 'function') proto = new proto(app);\n\
  framework.extend(" + func.name + ".prototype, proto);\n\
  if (args) this.__construct.apply(this, args);\n\
  else this.__construct.call(this, app);\n\
}\n\n\
// Original function\n";

    fnCode += func.toString() + "\n\n// Return function with new namespace\nreturn " + func.name + ';\n';
