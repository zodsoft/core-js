...
framework.extend(Application.prototype, new function() {
  ...
  // Application's paths. Override in app.js
  this.paths = {
    layout: '__layout/',
  ...
  // Storages
  this.cache = {}; // TODO: Remove all references
  this.storages = {};
  
  // Helpers: Automatically loaded from `app/helpers`, and
  // dynamically loaded from `framework/helpers`
  this.helpers = {};
  
  // All application's controllers
  this.controllers = {};
  
  // Application's models (automatically loaded)
  this.models = {};
  
  // View Engines: Automatically loaded from `framework/engines` and
  // extended by `app/engines`
  this.engines = {};
  
  // Default engine
  this.defaultEngine = null;
  
  // App's configuration, loaded from app/config.js
  this.config = {};
  
  // Per application globals
  this.globals = {};
  
  // Stores routes for all available controllers
  this.routes = {};
  
  // URL to redirect when a resource needs authentication
  this.loginUrl = '/login';
  
  // Debug color for the console
   ...
   */
   ...
   this.enable = function(feature, config) {
  ...
  this.registerEnable = function(feature, callback) {
  ...
  this.debug = function(msg) {
    ...
    msg = util.format('\033[%sm%s (%s) - %s\033[0m', this.debugColor, this.domain, this.date(), msg);
    console.log(msg);
  }
  ...
  this.getResource = function(scheme) {
  ...
  this.createMulti = function(object, options) {
