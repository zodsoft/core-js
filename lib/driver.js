...
framework.extend(Driver.prototype, new function() {
  ...
  // Cache keys. The items should be specified in the same order
  ...
  this.provideTo = function(context) {
    ...
    if (!context.hasOwnProperty('new')) {
      context.new = framework.driverProto.__modelMethods.new;
    }
  }
  ...
  */
  ...
  this.__modelMethods = {
    ...
    /** 
      ...
      Note: This method doesn't need to be implemented in the driver,
      unless it needs to be overridden for some reason.
