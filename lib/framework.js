...
_.extend(Framework.prototype, new function() {
  ...
  */
  ...
  /**
    Allows extension of framework's classes, by providing `this.extend` as
    a method attached to the function.
    
    The extend function receives a `parent` argument, which belongs to the 
    name of the framework class to extend.
    
    @param {function} func
    @returns {function} modified function, allowing `this.extend`
    @private
  */
  
  this.addInheritance = function(func) {
    
      /* TODO: accept func as object, allowing arbitrary prototypes */
    
      var fnCode = "\n\
// Makes inheritance possible\n\
" + func.name + ".prototype.extends = function(parent, args) {\n\
  framework.extend(this, new framework.lib[parent]());\n\
